...
export default async function AdminLihatLayananPage() {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-10">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Lihat Layanan</h1>
          <p className="mt-2 text-gray-500">
            Lihat, edit, nonaktifkan, atau hapus layanan yang tersedia.
          </p>
        </header>
